...
<body>
  ...
  <div class="video1">
      <iframe width="100%" height="315" src="Videos/curl.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Curl de bíceps</h2>
    </div>

    <div class="video2">
      <iframe width="100%" height="315" src="Videos/barra_z.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Curl barra Z</h2>
    </div>

    <div class="video3">
      <iframe width="100%" height="315" src="Videos/martillo.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Curl de martillo</h2>
    </div>

    <div class="video4">
      <iframe width="100%" height="315" src="Videos/curl_sentado.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Curl sentado</h2>
    </div>
