...
<body>
  ...
  <div class="video1">
      <iframe width="100%" height="315" src="Videos/press_banca.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Press de banca</h2>
    </div>

    <div class="video2">
      <iframe width="100%" height="315" src="Videos/press_banca_inclinado.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Press de banca inclinado</h2>
    </div>

    <div class="video3">
      <iframe width="100%" height="315" src="Videos/militar_multipower.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Press multipower</h2>
    </div>

    <div class="video4">
      <iframe width="100%" height="315" src="Videos/militar.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Press militar</h2>
    </div>
