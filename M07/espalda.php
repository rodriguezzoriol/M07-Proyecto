...
<body>
  ...
  <div class="video1">
      <iframe width="100%" height="315" src="Videos/jalon.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Jalón al pecho</h2>
    </div>

    <div class="video2">
      <iframe width="100%" height="315" src="Videos/remo.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Remo</h2>
    </div>

    <div class="video3">
      <iframe width="100%" height="315" src="Videos/remo_barra.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Remo con barra</h2>
    </div>

    <div class="video4">
      <iframe width="100%" height="315" src="Videos/peso_muerto.mp4" frameborder="0" allowfullscreen></iframe>
      <h2>Peso muerto</h2>
    </div>
